...
public abstract class MyShape{
	...
	Color color; //In each draw() method, the colour is set.
	...
	/**
	 * Constructor for shapes with two points: Circle, Square, Line
	 ...
	 * Note that two points are the same. This constructor takes points 
	 * rather than ints, this is due to me learning and trying different techniques.
	 * 
	 */
